...
export const Question = ({
  ...
  return (
    <div key={field.id} className="question-container-render">
      
      {field.imageUrl && (
        <div className="view-image-container">
          <div className="image-preview-render">
            <img
              src={field.imageUrl}
              alt=""
            />
      ...
      <div className="correct-answer-container">
        {form.type === "Quiz" && userResponse != null && (
          <>
            ...
            <span className="correct-answer-text">{renderCorrectAnswer(field)}</span>
          </>
        )}
      </div>
