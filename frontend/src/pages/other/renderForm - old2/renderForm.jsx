  ...
  const getForm = async () => {
    try {
      ...
      try {
        ...
        const formResponse = await getFormResponseByFormId(token, response.id);
            ...
            {displayedQuestions.map((field, index) => (
              <div key={field.id} className="question-container">
                <div className="question-title-wrapper">
                  ...
                  <span className="question-number">{calculateQuestionNumber(index)}.</span> {/* Use the function to get question number */}
                    {field.label}
