...
export const RenderForm = () => {
  ...
  const handleSaveResponse = async () => {
    ...
    const errors = form?.formFields
      .filter(q => q.required && !answers.find(a => a.questionId === q.id)?.value?.length) // Check if value is empty or missing
      .map(q => q.id);
    ...
    try {
      ...
      for (const answer of answers) {
        ...
        if (Array.isArray(value)) {
          ...
          // try {
          //   await createFormFieldOptionByUserAnswer(token, responseId, questionId, selectedValue);
          // } catch (error) {
          //   console.error("Error saving checkbox response:", error);
          // }
  ...
  <div>
            ...
            < div className="upload-container">
              ...
              {field.fieldType === "textbox" && (
                <div className="input-wrapper">
                  <input
                    type="text"
                    value={userResponse ? renderUserAnswers(field) : answers.find(a => a.questionId === field.id)?.value || ''}
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      checked={userResponse ? renderUserAnswers(field).includes(option.optionValue) : answers.find(a => a.questionId === field.id)?.value.includes(option.optionValue)}
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        value={option.optionValue}
                        checked={userResponse ?  isSelected : answers.find(a => a.questionId === field.id)?.value === option.optionValue}
    ...
    {!userResponse && (
      <div className="submit-button-container">
        <button className="submit-button" onClick={handleSaveResponse} disabled = {disableSave}>Submit</button>
      </div>
    )}
